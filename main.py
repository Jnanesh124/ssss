...
<Variable name="keycolor" description="Main Color" type="color" hideEditor="true" default="#ffe300" value="#ffe300"/>
...
<Group description="Theme Colors" selector="body">
  <Variable name="header.bg.color" description="Header Beackground" type="color" default="#ffffff" value="#ffffff"/>
  <Variable name="main.color" description="Theme Color" type="color" default="#ffe300" value="#ffe300"/>
  <Variable name="main.dark.color" description="Dark Color" type="color" default="#111111" value="#111111"/>
  <Variable name="menu.color" description="Menu Color" type="color" default="#111111" value="#111111"/>
  <Variable name="menu.hover.color" description="Menu Hover Color" type="color" default="#ffe300" value="#ffe300"/>
          ...
          <b:loop values='data:links' var='link'>
            <b:if cond='data:link.name == &quot;boxedVersion&quot;'>
              <b:if cond='data:link.target == &quot;true&quot;'>
                #outer-wrapper{max-width:1160px} 
              </b:if>
            </b:if>
          </b:loop>
          &lt;/style&gt;
    ...
    <div class='container row'>
      <div class='header-logo'>    
        <b:section class='main-logo' id='main-logo' maxwidgets='1' name='Header Logo' showaddelement='yes'>
              <b:widget id='Header1' locked='true' title='SoraFlix (Header)' type='Header' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEiNN5f2iWtN8-FCdmqQJlrUwZhrm8nVK1l1NfojAO-pzJtwEYbO3PVkp069ADw91VjdYS7M7dbtQO13sFAWVolxfRtBHSbypfAlM9ADzsq2qRBoN--OWQ0irKBgyEScCubTYiV3JL9WsUKaBfNM91KWl1_xlXoRPHeLmRZ-94PnFQ2sGSxC5pAOuoGTkA=s562</b:widget-setting>
                  <b:widget-setting name='displayHeight'>136</b:widget-setting>
                  <b:widget-setting name='sectionWidth'>150</b:widget-setting>
                  <b:widget-setting name='useImage'>true</b:widget-setting>
                  <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
                  <b:widget-setting name='imagePlacement'>REPLACE</b:widget-setting>
                  <b:widget-setting name='displayWidth'>562</b:widget-setting>
                </b:widget-settings>
                <b:includable id='main' var='this'>
              <div class='header-widget'>
                <b:include cond='data:imagePlacement in {&quot;REPLACE&quot;, &quot;BEFORE_DESCRIPTION&quot;}' name='image'/>
        ...
        <b:section class='main-menu' id='main-menu' maxwidgets='1' name='Main Menu' showaddelement='yes'>
          <b:widget id='LinkList74' locked='true' title='Link List' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='link-11'>https://www.soratemplates.com/2022/12/soraflix-blogger-templates.html</b:widget-setting>
              <b:widget-setting name='link-10'>https://youtu.be/ifVfghmxGP4</b:widget-setting>
              <b:widget-setting name='text-9'>_Web Doc</b:widget-setting>
              <b:widget-setting name='link-9'>https://www.sorabloggingtips.com/2022/12/how-to-setup-soraflix-blogger-template.html</b:widget-setting>
              <b:widget-setting name='text-8'>Documentation</b:widget-setting>
              <b:widget-setting name='link-7'>https://soraflix-soratemplates.blogspot.com/soratemplates</b:widget-setting>
              <b:widget-setting name='link-8'>#</b:widget-setting>
              <b:widget-setting name='link-5'>https://soraflix-soratemplates.blogspot.com/p/post-format-and-page-markup.html</b:widget-setting>
        ...
        <b:section class='top-bar-nav' id='top-bar-nav' maxwidgets='1' name='Top Navigation' showaddelement='yes'>
          <b:widget id='LinkList72' locked='true' title='Link List' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='link-1'>https://soraflix-soratemplates.blogspot.com/p/about.html</b:widget-setting>
              <b:widget-setting name='text-0'>Home</b:widget-setting>
              <b:widget-setting name='link-2'>https://soraflix-soratemplates.blogspot.com/p/contact-us.html</b:widget-setting>
              <b:widget-setting name='link-0'>/</b:widget-setting>
          ...
          <div id='sidebar-wrapper'>
            ...
            <b:section class='sidebar' id='social-widget' maxwidgets='1' name='Social Widget' showaddelement='yes'>
              <b:widget id='LinkList75' locked='true' title='Follow Us' type='LinkList' version='2' visible='true'>
                <b:widget-settings>
                  ...
                  <b:widget-setting name='link-6'>https://www.youtube.com/liveblogger</b:widget-setting>
                  <b:widget-setting name='link-3'>#</b:widget-setting>
            ...
            <b:section class='sidebar common-widget' id='sidebar-r2' name='Sidebar Right (B)' showaddelement='yes'>
              <b:widget id='HTML1' locked='false' title='Recents in Bollywood Movies' type='HTML' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='content'>3/Bollywood/post-list</b:widget-setting>
                </b:widget-settings>
                <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    ...
    <data:content/>
              ...
              <b:widget id='Label1' locked='false' title='Categories' type='Label' version='2' visible='true'>
                <b:widget-settings>
                  ...
                  <b:widget-setting name='selectedLabelsList'>Avengers,Bollywood,Crime,Hollywood,Movie,Series</b:widget-setting>
...
<div class='tags-wrapper'>
   <b:section class='menu-cat row' id='menu-cat' maxwidgets='1' name='Categories Menu' showaddelement='yes'>
